...
const Projects = (props) => {
  return (
    <div className="projects-container">
      <Helmet>
        <title>Projects - SlickSpore</title>
        <meta property="og:title" content="Projects - SlickSpore" />
      </Helmet>
      <header data-role="Header" className="projects-header">
        ...
        <div className="projects-icon-group">
          <a
            href="https://instagram.com/classic_.3tt"
            target="_blank"
            rel="noreferrer noopener"
          >
            <svg viewBox="0 0 877.7142857142857 1024" className="projects-icon">
      ...
      <footer className="projects-footer">
        ...
        <div className="projects-container4">
          ...
          <div className="projects-icon-group2">
            <a
